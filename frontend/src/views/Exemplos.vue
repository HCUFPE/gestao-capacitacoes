  ...
  <Card>
    <template #header>
      <div class="flex items-center space-x-2">
        ...
        <h1 class="text-2xl font-bold">Exemplos de Componentes e Layout</h1>
      </div>
    </template>
        ...
        <div class="grid grid-cols-12 gap-6">
          <div class="col-span-12 md:col-span-6">
            <div class="form-group mb-4">
              <label for="name" class="form-label block text-sm font-medium text-paper-text mb-1">Nome Completo</label>
              <Field name="name" type="text" id="name" class="form-control block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-paper-primary focus:border-paper-primary sm:text-sm" placeholder="Digite seu nome" validate-on-input />
              <ErrorMessage name="name" class="text-red-500 text-sm mt-1" />
            </div>
          </div>
          <div class="col-span-12 md:col-span-6">
            <div class="form-group mb-4">
              <label for="email" class="form-label block text-sm font-medium text-paper-text mb-1">Endereço de E-mail</label>
              <Field name="email" type="email" id="email" class="form-control block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-paper-primary focus:border-paper-primary sm:text-sm" placeholder="seu@email.com" validate-on-input />
              <ErrorMessage name="email" class="text-red-500 text-sm mt-1" />
            </div>
          </div>
          <div class="col-span-12">
            <div class="form-group mb-4">
              <label for="message" class="form-label block text-sm font-medium text-paper-text mb-1">Mensagem</label>
              <Field as="textarea" name="message" id="message" rows="4" class="form-control block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-paper-primary focus:border-paper-primary sm:text-sm" placeholder="Deixe sua mensagem..." validate-on-input />
