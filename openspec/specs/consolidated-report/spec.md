...
## Purpose
O sistema SHALL prover um relatório consolidado para comprovação de capacitações no sistema Mentor, acessível pela Chefia e pela UDP, com filtros, exportação e visualização de certificados.
## Requirements
