# granular-course-assignment Specification

## Purpose
O sistema SHALL permitir que Chefia selecione um curso e escolha pessoas específicas de sua equipe (lotacao) para receberem a atribuição, distinguindo-se da atribuição em massa.
## Requirements
